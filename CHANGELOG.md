...
***  
* v 0.5.3: Added SystemEnvironment cps, mem, and other attributes which were only sent as a change, as part of the Environment properties.  
* v 0.5.2: Added badge for mocha tests  
